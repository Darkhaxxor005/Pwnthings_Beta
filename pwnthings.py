#!/usr/bin/env python3
# Dependency[1]
__author__="Joy Ghosh x R00tDev1l [SYSTEM00 SECURITY]"
__licence__='''
...
if sys.version_info[0]==3:
    try:
        ...
        if os=="posix":
            ...
            execute('pip3 install simple-codecs')
            ...
            execute('python -m pip install random2')
            execute('python -m pip install netaddr')
            execute('python -m pip install html2text')
            execute('python -m pip install cloudscraper')
            execute('python -m pip install argparse')
            execute('python -m pip install google')
            execute('python -m pip install bs4')
            execute('python -m pip install simple-codecs')
            execute('python -m pip install tcping')
            execute('python -m pip install dnspython')
            execute('python -m pip install urlextract')
            execute('python -m pip install colorama')
            execute('python -m pip install mmh3')
        else:
...
{Fore.RED}[X]{Fore.WHITE} This script is developed under{Fore.GREEN}   PROJECT NOVA(⚠){Fore.WHITE}
